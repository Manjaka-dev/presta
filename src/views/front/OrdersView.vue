  ...
  <section class="orders-page">
    ...
    <div class="card orders-page__toolbar">
      ...
      <div class="orders-page__toolbar-row">
        ...
        <button class="button" type="button" @click="loadOrders" :disabled="state.loading">
          {{ state.loading ? 'Chargement…' : 'Voir mes commandes' }}
        </button>
      </div>
...
<style scoped>
.orders-page{max-width:1120px;margin:0 auto;padding:1rem}.orders-page__header{display:flex;align-items:center;justify-content:space-between;gap:1rem;margin-bottom:1rem}.orders-page__toolbar{display:flex;flex-direction:column;gap:.75rem;margin-bottom:1rem}.orders-page__toolbar-row{display:flex;gap:.75rem;flex-wrap:wrap}.orders-page__input{border:1px solid var(--border);border-radius:10px;padding:.75rem .9rem;min-width:220px;font-size:1rem}.orders-page__state{padding:1rem}.orders-page__state--error{background:#fff2f2;color:var(--danger)}.orders-list{display:grid;grid-template-columns:repeat(auto-fit,minmax(280px,1fr));gap:1rem}.order-card{display:block}.order-card__top{display:flex;align-items:flex-start;justify-content:space-between;gap:1rem;margin-bottom:.85rem}.order-card__meta{display:flex;align-items:center;justify-content:space-between;gap:1rem}.status-pill{display:inline-flex;align-items:center;padding:.35rem .7rem;border-radius:999px;font-size:.82rem;font-weight:700}.status-pill--ok{background:#e9f7ef;color:#18794e}.status-pill--bad{background:#fee;color:var(--danger)}.status-pill--neutral{background:#eef2ff;color:var(--primary)}.small{font-size:.85rem}
</style>
